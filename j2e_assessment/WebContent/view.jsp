...
<body>
  ...
  <h1 class="display-4">View Ads Here</h1>
  <p class="lead">Please Select the type of Ad that you want to view from the following list.</p>
  <hr class="my-4">

</div>

<div class="container">
	<form action="viewad" method="get">
		...
		<div class="form-group">
				...
				<p style="color: red"><% 
			if(request.getAttribute("data")=="0"){
			out.print("No Ads available for selected type...");
			}
		%></p>
